...
def analyze_figure(): # Анализировать фигуру на поле
    ...
    global vertexes, sides, angeles, closed, flags, r, figure_id, S, P
    ...
    if len(vertexes[0]) == 4 and closed: # Вычисляем параметры треугольника
